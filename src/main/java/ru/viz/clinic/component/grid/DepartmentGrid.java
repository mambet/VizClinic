...
public class DepartmentGrid extends Grid<Department> implements HospitalGridUpdater {
    ...
    public void updateHospital(Optional<Hospital> optionalHospital) {
        optionalHospital.ifPresentOrElse(hospital -> departmentFilter.setHospital(hospital),
                () -> departmentFilter.setHospital(null));
